...
# Create dummy user
User1 = User(name="Jazz", email="jro0005@uah.edu")
session.add(User1)
session.commit()
...
catalog2 = Catalog(user_id=1, name="Dan Izakaya")
...
catalog3 = Catalog(user_id=1, name="Panda Garden")
...
catalog5 = Catalog(user_id=1, name="Tony\'s Bistro ")
